...
import { skolemizeCompactJsonLd, toDeskolemizedNQuads, createHmac,
  createHmacIdLabelMapFunction, labelReplacementCanonicalizeNQuads } from '@digitalbazaar/di-sd-primitives';
...
let skolemThings = await skolemizeCompactJsonLd({document, options})
...
let deSkQuads = await toDeskolemizedNQuads({document: skolemThings.expanded, options});
console.log("\ndeskolemized quads:")
