/*
    Steps to create a signed verifiable credential with an cryptosuite of *ecdsa-rdfc-2019*
    based on "DataIntegrityProof" representation, using curve P-256.
*/
...
// Sign
const msgHash = sha256(combinedHash) // Hash is done outside of the algorithm in noble/curve case.
...
const result = p256.verify(signature, msgHash, pbk)
console.log(`Signature verified: ${result}`)

// Construct Signed Document
const signedDocument = Object.assign({}, document)
