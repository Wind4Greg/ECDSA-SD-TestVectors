...
// bbsSignature, bbsHeader, publicKey, hmacKey, mandatoryPointers, and pid

let proofValue = new Uint8Array([0xd9, 0x5d, 0x06])
const components = [bbsSignature, bbsHeader, publicKey, hmacKey, mandatoryPointers, pidMaterial]
