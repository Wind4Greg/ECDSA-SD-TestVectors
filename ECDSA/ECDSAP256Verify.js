...
const document = Object.assign({}, signedDocument)
...
// Combine hashes
const combinedHash = concatBytes(proofHash, docHash) // Hash order different from draft

// Get public key
const encodedPbk = signedDocument.proof.verificationMethod.split('#')[1]
