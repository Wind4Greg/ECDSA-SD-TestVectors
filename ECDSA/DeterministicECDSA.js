/*
    Checking the noble curve implementation against the test vectors in:
...
const Q = P256.ProjectivePoint.fromPrivateKey(privateKey).toAffine()
console.log(Q)
...
const Q384 = P384.ProjectivePoint.fromPrivateKey(privateKey384).toAffine()
console.log(Q384)
// Should be 60FED4BA255A9D31C961EB74C6356D68C049B8923B61FA6CE669622E60F29FB6
...
*/
const msgHash384 = sha384(message)
const sig384 = P384.sign(msgHash384, privateKey384)
console.log(sig384)
